...
import { useModal, Drawer } from '../../index';
      ...
      <section className="card bg-base-200/50 p-12 border border-base-300 items-center justify-center">
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-[12px] font-medium text-base-content/40 tracking-tight uppercase">
            Toggle to test different screen entry points
          </p>
        </div>

        <Drawer isOpen={isOpen} onClose={close} position={position} title="Cart Summary" size="md">
          <div className="space-y-6">
            <div className="p-4 bg-base-300 rounded-lg">Product A x 2 - $40.00</div>
            <div className="p-4 bg-base-300 rounded-lg">Product B x 1 - $25.00</div>
